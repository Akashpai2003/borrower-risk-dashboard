...
import { CheckCircle2, ChevronRight, ChevronLeft, IndianRupee } from "lucide-react";
  ...
  return (
    <form onSubmit={handleSubmit}>
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3 w-full max-w-7xl mx-auto">
        <Card className="col-span-full md:col-span-2 lg:col-span-3 border-purple-200 shadow-lg">
          <CardHeader className="bg-gradient-to-r from-purple-50 to-indigo-50">
            <CardTitle className="text-2xl text-purple-900">Loan Application</CardTitle>
            <CardDescription className="text-purple-700">Enter borrower information to assess loan risk</CardDescription>
          </CardHeader>
          
          <div className="px-6 pt-4">
            <div className="flex justify-between mb-8 relative">
              <div className="w-full flex justify-between items-center">
                <div className={`flex-1 text-center ${currentStep === 'personal' ? 'text-purple-700 font-medium' : 'text-gray-500'}`}>
                  <div className={`w-10 h-10 mx-auto rounded-full flex items-center justify-center ${currentStep === 'personal' ? 'bg-purple-100 text-purple-700' : 'bg-gray-100 text-gray-500'}`}>
                    1
                  </div>
                  <div className="mt-2">Personal</div>
                </div>
                <div className={`flex-1 text-center ${currentStep === 'financial' ? 'text-purple-700 font-medium' : 'text-gray-500'}`}>
                  <div className={`w-10 h-10 mx-auto rounded-full flex items-center justify-center ${currentStep === 'financial' ? 'bg-purple-100 text-purple-700' : 'bg-gray-100 text-gray-500'}`}>
                    2
                  </div>
                  <div className="mt-2">Financial</div>
                </div>
                <div className={`flex-1 text-center ${currentStep === 'loan' ? 'text-purple-700 font-medium' : 'text-gray-500'}`}>
                  <div className={`w-10 h-10 mx-auto rounded-full flex items-center justify-center ${currentStep === 'loan' ? 'bg-purple-100 text-purple-700' : 'bg-gray-100 text-gray-500'}`}>
                    3
                  </div>
                  <div className="mt-2">Loan</div>
                </div>
                <div className={`flex-1 text-center ${currentStep === 'additional' ? 'text-purple-700 font-medium' : 'text-gray-500'}`}>
                  <div className={`w-10 h-10 mx-auto rounded-full flex items-center justify-center ${currentStep === 'additional' ? 'bg-purple-100 text-purple-700' : 'bg-gray-100 text-gray-500'}`}>
                    4
                  </div>
          ...
          <CardContent>
            <Tabs value={currentStep} className="w-full" onValueChange={setCurrentStep}>
              ...
              <TabsContent value="personal" className="space-y-6 mt-0">
                <div>
                  <h3 className="text-lg font-medium mb-4 text-purple-800">Borrower Information</h3>
                  <div className="grid gap-4 sm:grid-cols-2">
                    <div className="grid gap-2">
                      ...
                      <Input
                        ...
                        required
                        className="border-purple-200 focus:border-purple-300 focus-visible:ring-purple-300"
                      />
                    </div>
                    <div className="grid gap-2">
                ...
                <div>
                  <h3 className="text-lg font-medium mb-4 text-purple-800">Address</h3>
                  <div className="grid gap-4 sm:grid-cols-2">
                ...
                <div>
                  <h3 className="text-lg font-medium mb-4 text-purple-800">Personal Status</h3>
                  <div className="grid gap-4 sm:grid-cols-2">
                    <div className="grid gap-2">
                      ...
                      >
                        <SelectTrigger className="border-purple-200 focus:border-purple-300 focus-visible:ring-purple-300">
              ...
              <TabsContent value="financial" className="space-y-6 mt-0">
                <div>
                  <h3 className="text-lg font-medium mb-4 text-purple-800">Income & Employment</h3>
                  <div className="grid gap-4 sm:grid-cols-2">
                    <div className="grid gap-2">
                ...
                <div>
                  <h3 className="text-lg font-medium mb-4 text-purple-800">Credit Profile</h3>
                  <div className="grid gap-4 sm:grid-cols-2">
                    <div className="grid gap-2">
              ...
              <TabsContent value="loan" className="space-y-6 mt-0">
                <div>
                  <h3 className="text-lg font-medium mb-4 text-purple-800">Loan Request</h3>
                  <div className="grid gap-4 sm:grid-cols-2">
                    <div className="grid gap-2">
                ...
                <div>
                  <h3 className="text-lg font-medium mb-4 text-purple-800">Additional Loan Details</h3>
                  <div className="grid gap-4 sm:grid-cols-2">
                    <div className="grid gap-2">
                      <div className="flex items-center justify-between">
              ...
              <TabsContent value="additional" className="space-y-6 mt-0">
                <div>
                  <h3 className="text-lg font-medium mb-4 text-purple-800">Asset & Liability Information</h3>
                  <div className="grid gap-4 sm:grid-cols-2">
                    <div className="grid gap-2">
                ...
                <div>
                  <h3 className="text-lg font-medium mb-4 text-purple-800">Additional Notes</h3>
                  <div className="grid gap-4">
                    <div className="grid gap-2">
                      ...
                      <Textarea
                        ...
                        className="min-h-32 border-purple-200 focus:border-purple-300 focus-visible:ring-purple-300"
                      />
                    </div>
                  </div>
                </div>
